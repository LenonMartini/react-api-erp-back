...
INSERT INTO `companies` (`id`, `location_id`, `social_reason`, `abbreviated`, `cnpj`, `ie`, `im`, `email`, `image_logo`, `status`) VALUES
	(1, 1, 'Hospital de Caridade Dona Darcy Vargas', 'Hospital Darcy Vargas', '80.672.561/0001-76', NULL, NULL, 'hospitaldarcyvargas.com.br', 'logo.png', 1),
	(2, 1, 'Teste', 'teste', '11.111.111/1111-11', NULL, NULL, 'teste@teste.com', 'teste.logo', 1);
...
-- Copiando dados para a tabela dhosp.locations: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `locations` DISABLE KEYS */;
INSERT INTO `locations` (`id`, `cep`, `andress`, `district`, `city`, `state`, `uf`, `created_at`, `updated_at`) VALUES
	(1, '84.550-000', 'Rua Armando Costa', 'centro', 'Rebouças', 'Paraná', 'PR', '2021-10-30 09:09:33', NULL);
...
-- Copiando dados para a tabela dhosp.migrations: ~3 rows (aproximadamente)
