...
INSERT INTO `companies` (`id`, `social_reason`, `abbreviated`, `cnpj`, `fone`, `ie`, `im`, `email`, `logo`, `status`, `cep`, `andress`, `number`, `district`, `city`, `state`, `uf`) VALUES
	(4, 'Empresa de Teste', 'Hospital de Caridade Dona Darcy Vargas', '34.345.345/0001-34', '(42) 3457-1300', 'Isento', NULL, NULL, 'darcy_vargas.png', 1, '84550-000', 'Rua Armando Costa', 619, 'centro', 'Rebouças', 'Parana', 'PR'),
	(32, 'dsadasdasdas', 'dsadasdsadsad', 'dsadsadad', 'dsadasdsada', 'dsadasdas', 'dsadsadadas', 'dsadads@dsadsada', NULL, 0, '84550-000', 'teste', 12, 'teste', 'Rebouças', 'Paraná', 'PR');
/*!40000 ALTER TABLE `companies` ENABLE KEYS */;

-- Copiando estrutura para tabela portal.companies_users
...
-- Copiando dados para a tabela portal.companies_users: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela portal.sessions: ~4 rows (aproximadamente)
...
INSERT INTO `users` (`id`, `group_id`, `name`, `email`, `password`, `status`) VALUES
	(1, 0, 'Lenon Emanuel Martini', 'lenonmartini21@gmail.com', '$2y$10$MEZn9rY6JHDLmYFBbAO8l.fZB30IKXGufYipCTnVbn5hLVVwWj60q', 1),
	(2, 0, 'teste', 'teste@teste.com', '$2y$10$MEZn9rY6JHDLmYFBbAO8l.fZB30IKXGufYipCTnVbn5hLVVwWj60q', 1),
	(3, 0, 'teste2', 'teste2@gmail.com', '$2y$10$MEZn9rY6JHDLmYFBbAO8l.fZB30IKXGufYipCTnVbn5hLVVwWj60q', 1);
