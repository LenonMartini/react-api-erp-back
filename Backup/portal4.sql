...
INSERT INTO `companies` (`id`, `social_reason`, `abbreviated`, `cnpj`, `fone`, `ie`, `im`, `email`, `logo`, `status`, `cep`, `andress`, `number`, `district`, `city`, `state`, `uf`) VALUES
	(4, 'Empresa de Teste 1', 'Hospital de Caridade Dona Darcy Vargas', '34.345.345/0001-34', '(42) 3457-1300', 'Isento', NULL, NULL, 'darcy_vargas.png', 1, '84550-000', 'Rua Armando Costa', 619, 'centro', 'Rebouças', 'Parana', 'PR'),
...
-- Copiando dados para a tabela portal.users: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`id`, `group_id`, `name`, `email`, `cpf`, `password`, `status`) VALUES
	(1, 0, 'Lenon Emanuel Martini', 'lenonmartini21@gmail.com', '', '$2y$10$MEZn9rY6JHDLmYFBbAO8l.fZB30IKXGufYipCTnVbn5hLVVwWj60q', 1),
	(4, 0, 'teste', 'teste@gmail.com', '111.111.111-11', '12345678', 1);
